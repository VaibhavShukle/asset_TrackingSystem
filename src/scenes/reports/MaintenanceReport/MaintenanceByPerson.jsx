  ...
  const getVendor = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8081/api/vendor/getvendor/`
      );
        ...
        >
          ...
          >
            ...
            <div style={{ marginRight: "300px", marginTop: "10px" }}>
              <Typography>Maintenance Schedule by Assigned Person</Typography>
            </div>
            <Button
              variant="contained"
              color="success"
...
export default MaintenanceByPerson;
